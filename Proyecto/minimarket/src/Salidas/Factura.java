...
public class Factura extends javax.swing.JInternalFrame {
    ...
    ///con este codigo optenemos a mi TXTBOX EL ULTIMO NRO DE MOVIMIENTO     
    void numeros_mov() {
        int j;
        int cont = 1;
        String num = "";
    ...
    void detallefactura(){
        for (int i = 0; i < tbdet.getRowCount(); i++) {
            String InsertarSQL = "INSERT INTO detallefactura(num_fac,cod_pro,des_pro,marca,cant_pro,pre_unit,pre_tot) VALUES (?,?,?,?,?,?,?)";
            String numfac = txtfac.getText();
            String codpro = tbdet.getValueAt(i, 0).toString();
            String despro = tbdet.getValueAt(i, 1).toString();
            String marpro = tbdet.getValueAt(i, 2).toString();
    ...
    void Movimientos_det() {
        for (int i = 0; i < tbdet.getRowCount(); i++) {
            ...
            String despro = tbdet.getValueAt(i, 1).toString();
            String marpro = tbdet.getValueAt(i, 2).toString();
            String cantpr = tbdet.getValueAt(i, 4).toString();
    ...
    private void initComponents() {
        ...
        tbdet.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Marca", "Precio", "Cantidad", "Importe"
            }
        ) {
        ...
        jLabel6.setText("RUC 10459121990");
...
private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
    ...
    if((txtcod.getText().equals("")) || (txtsubtotal.getText().equals(""))) {
        ...
        for(int i=0;i<Factura.tbdet.getRowCount();i++) {
            ...
            capcan=Factura.tbdet.getValueAt(i, 4).toString();
