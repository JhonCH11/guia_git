...
import Formulario.GenerarCodigos;
...
public class IngresoProductos extends javax.swing.JInternalFrame {
   ...
   void mostrartipoproducto(){
    ...
    void cargar(String valor) {
        try{
            String [] titulos={"Codigo","Descripcion","Marca","Precio","Stock","tipo producto"};
            ...
            while(rs.next()){
                ...
                registros[4]=rs.getString("Stock");
                 registros[5]=rs.getString("descrip");
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(20, 20, 20)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtdes, javax.swing.GroupLayout.DEFAULT_SIZE, 342, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jScrollPane2, javax.swing.GroupLayout.Alignment.TRAILING, 0, 570, Short.MAX_VALUE)
...
// Declaramos variables
    String cod,des,mar,pre,stock;
            ...
            sql="INSERT INTO producto (cod_pro,descripcion,marca,precio,Stock,idtip) VALUES (?,?,?,?,?,?)";
        try {
...
// TODO add your handling code here:
     String sql="UPDATE producto SET precio = '"+txtpre.getText()+"',descripcion ='"+txtdes.getText()+"', marca ='"+txtMarca.getText()+"', Stock = '"+txtstock.getText()+"' WHERE cod_pro = '"+txtcod.getText()+"'"; 
    try {
        PreparedStatement pst = cn.prepareStatement(sql);
        pst.executeUpdate();
